...
<section class="relative bg-gradient-to-l from-slate-950 via-gray-950 to-slate-950  overflow-hidden ">
    ...
    <div class="relative  max-w-7xl mx-auto px-6 mt-[50px]">
      ...
      <div>
       <p class="text-center text-sm text-[#73bc01] mb-5 "> Designed and Developed by <a href="https://softgrowthinfotech.com/" class="underline hover:text-blue-500">Softgrowth Infotech</a></p>
      </div>
    </div>
