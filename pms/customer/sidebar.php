...
<div class=" sidebar-text p-4 flex justify-center items-center">
 <h1 class="text-2xl md:text-3xl font-serif font-semibold tracking-[0.25em]
  ...
  <nav class="mt-6 space-y-2 px-2">
    ...
    <a href="refer_customer.php"
     class="menu-item <?php if($current=='refer_customer.php') echo 'active'; ?>">
      <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     <a href="list_refer_customer.php"
     class="menu-item <?php if($current=='list_refer_customer.php') echo 'active'; ?>">
    <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
   ...
   <a href="my_bookings.php"
     class="menu-item <?php if($current=='my_bookings.php') echo 'active'; ?>">
