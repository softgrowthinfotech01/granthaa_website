  ...
  <div>
    ...
    <nav class="mt-6 space-y-2 px-2">
      ...
      <a href="refer_customer"
        class="menu-item <?php if ($current == 'refer_customer') echo 'parent-active'; ?>">
        <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="list_refer_customer"
        class="menu-item <?php if ($current == 'list_refer_customer') echo 'parent-active'; ?>">
        <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="my_bookings"
        class="menu-item <?php if ($current == 'my_bookings') echo 'parent-active'; ?>">
      ...
      <a href="my_booking_payment"
        class="menu-item <?php if ($current == 'my_booking_payment') echo 'parent-active'; ?>">
        <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" d="M7 3h8l4 4v14l-2-1-2 1-2-1-2 1-2-1-2 1V5a2 2 0 0 1 2-2z" />
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 3v4h4" />
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 10h6" />
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 14h3" />
          <path stroke-linecap="round" stroke-linejoin="round" d="M11.5 17c1.2 0 2-.6 2-1.4 0-.9-.8-1.3-2-1.6-1.2-.3-2-.7-2-1.6 0-.8.8-1.4 2-1.4m0 0V10m0 7v1" />
        </svg>
        <span class="sidebar-text">My Booking Payments</span>
      </a>
