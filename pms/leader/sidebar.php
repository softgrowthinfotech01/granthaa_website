...
<div class=" sidebar-text p-4 flex justify-center items-center">
 <h1 class="text-2xl md:text-3xl font-serif font-semibold tracking-[0.25em]
  ...
  <nav class="mt-6 space-y-2 px-2">
    ...
    <a href="dashboard.php"
     class="menu-item <?php if($current=='dashboard.php') echo 'active'; ?>">
      <!-- home icon -->
    ...
    <a href="add_advisor.php"
     class="menu-item <?php if($current=='add_advisor.php') echo 'active'; ?>">
      <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="set_commission.php"
     class="menu-item <?php if($current=='set_commission.php') echo 'active'; ?>">
     <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
     ...
     <a href="customer_booking.php"
     class="menu-item <?php if($current=='customer_booking.php') echo 'active'; ?>">
     <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M12 4v16m8-8H4"/>
      </svg>
    ...
    <a href="list_advisor.php"
     class="menu-item <?php if($current=='list_advisor.php') echo 'active'; ?>">
      <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     class="menu-item <?php if($current=='list_commission.php') echo 'active'; ?>">
 <svg class="w-6 h-6 text-yellow-500" fill="currentColor" viewBox="0 0 24 24">
    ...
    <rect x="7" y="16" width="10" height="2"/>
     ...
     class="menu-item <?php if($current=='list_customer_booking.php') echo 'active'; ?>">
      <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M3 7h18M3 12h18M3 17h18"/>
      </svg>
    ...
    <a href="team_performance.php"
     class="menu-item <?php if($current=='team_performance.php') echo 'active'; ?>">
      <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
