...
$(document).ready(function() {
    ...
    item.commission_type === 'percent'
        ? `<span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-semibold">Percent (%)</span>`
        : `<span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-semibold">Amount (₹)</span>`
    }
</td>
