...
Route::delete('booking/{id}/force-delete', [BookingController::class,'forceDelete']); // permemet delete
    ...
    Route::get('/mydelbookings', [BookingController::class, 'mydelbookings']);
    Route::get('/cstbookings', [BookingController::class, 'cstbookings']);
...
Route::middleware(['auth:sanctum', 'role:admin,leader,adviser,customer'])->group(function () {
    ...
    Route::get('customer-visits/{id}', [CustomerVisitController::class, 'show']);
    Route::post('customer-visits', [CustomerVisitController::class, 'store']);
    Route::post('/customer-visits/{id}/release', [CustomerVisitController::class, 'release']);
});
