...
<select class="w-full border border-gray-300 px-5 py-3 rounded-xl focus:ring-2 focus:ring-green-400 outline-none">
...
<!-- BUTTON -->
 <!-- Buttons -->
  <div class="md:col-span-2 flex justify-between mt-6">
    ...
    <button type="submit"
      class="bg-green-500 hover:bg-green-600 text-black px-6 py-2 rounded-lg font-semibold transition">
