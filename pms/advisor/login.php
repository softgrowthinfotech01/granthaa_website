...
<head>
<meta charset="UTF-8">
<title>Advisor Login | Granthaa Land Developer Pvt Ltd</title>
...
<div class="w-full max-w-md">
  ...
  <div class="bg-white/10 backdrop-blur-md rounded-xl shadow-2xl p-8 border border-white/20">
    ...
    <div class="flex justify-center mb-3">
      <img src="../images/logo.png" alt="Logo" class="h-25 w-60 rounded-lg border-2 border-green-500 shadow-md">
    </div>

    <!-- Heading -->
    <h2 class="text-center text-xl font-serif font-semibold tracking-widest text-green-500">
      ADVISOR LOGIN
    </h2>
    ...
    <form class="space-y-5">
      ...
      <!-- Login Button -->
      <button
        class="w-full mt-4 bg-green-500 text-black py-2.5 rounded-md
