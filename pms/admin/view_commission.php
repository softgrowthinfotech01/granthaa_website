...
<div class="w-full md:w-[90%] lg:w-[75%] xl:w-[60%] mx-auto my-4 self-start rounded-lg bg-slate-100 p-4 md:p-6 border border-default shadow-xs hover:bg-neutral-secondary-medium">
    ...
    <div class="w-full overflow-x-auto">
        ...
        <table class="w-full text-md text-left text-gray-600 min-w-[800px]">
