                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if ($status == "Current") {
                                ...
                                echo "<span class='badge bg-primary'>Complete</span>";
                              }
                              ?>
                            </td>

                            <td>
                              <img src="uploads/<?php echo $row['project_image']; ?>" width="70">
                            </td>
                            ...
                            <td>
                              <a href="update_project.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-info">Edit</a>
                              <a href="delete_project.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"
